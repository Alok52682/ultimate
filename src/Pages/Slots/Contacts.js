...
const Contacts = () => {
    ...
    return (
        <div className="card-body p-5 relative">
            <div className="form-control mt-6 md:mt-12 flex flex-row gap-1">
                <input {...register("phoneCode")} type="text" defaultValue={'+880'} className="border-0 border-b-2 border-grey-dark px-3 py-2 text-lg w-2/6 md:w-1/5 text-[#767676]" />
                <input {...register("phone", { required: true })} type="text" placeholder="1XXXXXX" className="border-0 border-b-2 border-grey-dark px-3 py-2 text-lg w-4/6 md:w-4/5" />
            ...
            <Link to='/' className='text-[#767676] font-bold text-xs absolute bottom-[190px] md:bottom-[160px] '>Back</Link>
